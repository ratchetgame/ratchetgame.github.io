...
//-----------------------------------------------------------------------------
/*:
 * @plugindesc Use an image to display a visibility range image around the player's position
 *
 ...
 * visibility range is.
 *
 * The image used for the transparency by default is taken from:
 * YourProject/img/system/VisibilityRange1.png
